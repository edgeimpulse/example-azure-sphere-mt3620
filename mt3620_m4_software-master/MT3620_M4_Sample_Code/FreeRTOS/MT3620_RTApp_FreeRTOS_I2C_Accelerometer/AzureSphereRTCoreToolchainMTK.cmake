...
set(CMAKE_C_FLAGS_INIT "-std=gnu11 -mthumb -mcpu=cortex-m4 -mfloat-abi=softfp -mfpu=fpv4-sp-d16 -Wall -I${ARM_GNU_BASE_PATH}/arm-none-eabi/include/c++/9.3.1/ -I${ARM_GNU_BASE_PATH}/arm-none-eabi/include/")
set(CMAKE_CXX_FLAGS_INIT "-std=gnu++14 -lstdc++ -lsupc++ -fno-common -fno-exceptions -fno-rtti -mthumb -mcpu=cortex-m4 -mfloat-abi=softfp -mfpu=fpv4-sp-d16 -Wall  -I${ARM_GNU_BASE_PATH}/arm-none-eabi/include/c++/9.3.1/ -I${ARM_GNU_BASE_PATH}/arm-none-eabi/include/")
